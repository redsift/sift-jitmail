...
var time$2 = "%H:%M:%S";
var periods$1 = ["AM","PM"];
var days$1 = ["Sonntag","Montag","Dienstag","Mittwoch","Donnerstag","Freitag","Samstag"];
var shortDays$1 = ["So","Mo","Di","Mi","Do","Fr","Sa"];
var months$1 = ["Januar","Februar","März","April","Mai","Juni","Juli","August","September","Oktober","November","Dezember"];
...
var time$4 = "%H:%M:%S";
var periods$3 = ["AM","PM"];
var days$3 = ["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"];
var shortDays$3 = ["Sun","Mon","Tue","Wed","Thu","Fri","Sat"];
var months$3 = ["January","February","March","April","May","June","July","August","September","October","November","December"];
...
var time$7 = "%H:%M:%S";
var periods$6 = ["AM","PM"];
var days$6 = ["domingo","lunes","martes","miércoles","jueves","viernes","sábado"];
var shortDays$6 = ["dom","lun","mar","mié","jue","vie","sáb"];
var months$6 = ["enero","febrero","marzo","abril","mayo","junio","julio","agosto","septiembre","octubre","noviembre","diciembre"];
...
var days$7 = ["sunnuntai","maanantai","tiistai","keskiviikko","torstai","perjantai","lauantai"];
var shortDays$7 = ["Su","Ma","Ti","Ke","To","Pe","La"];
var months$7 = ["tammikuu","helmikuu","maaliskuu","huhtikuu","toukokuu","kesäkuu","heinäkuu","elokuu","syyskuu","lokakuu","marraskuu","joulukuu"];
...
var time$9 = "%H:%M:%S";
var periods$8 = ["",""];
var days$8 = ["dimanche","lundi","mardi","mercredi","jeudi","vendredi","samedi"];
var shortDays$8 = ["dim","lun","mar","mer","jeu","ven","sam"];
var months$8 = ["janvier","février","mars","avril","mai","juin","juillet","août","septembre","octobre","novembre","décembre"];
...
var days$10 = ["ראשון","שני","שלישי","רביעי","חמישי","שישי","שבת"];
var shortDays$10 = ["א׳","ב׳","ג׳","ד׳","ה׳","ו׳","ש׳"];
var months$10 = ["ינואר","פברואר","מרץ","אפריל","מאי","יוני","יולי","אוגוסט","ספטמבר","אוקטובר","נובמבר","דצמבר"];
...
var days$11 = ["vasárnap","hétfő","kedd","szerda","csütörtök","péntek","szombat"];
var shortDays$11 = ["V","H","K","Sze","Cs","P","Szo"];
var months$11 = ["január","február","március","április","május","június","július","augusztus","szeptember","október","november","december"];
...
var days$12 = ["Domenica","Lunedì","Martedì","Mercoledì","Giovedì","Venerdì","Sabato"];
var shortDays$12 = ["Dom","Lun","Mar","Mer","Gio","Ven","Sab"];
var months$12 = ["Gennaio","Febbraio","Marzo","Aprile","Maggio","Giugno","Luglio","Agosto","Settembre","Ottobre","Novembre","Dicembre"];
...
var days$13 = ["日曜日","月曜日","火曜日","水曜日","木曜日","金曜日","土曜日"];
var shortDays$13 = ["日","月","火","水","木","金","土"];
var months$13 = ["睦月","如月","弥生","卯月","皐月","水無月","文月","葉月","長月","神無月","霜月","師走"];
...
var days$14 = ["일요일","월요일","화요일","수요일","목요일","금요일","토요일"];
var shortDays$14 = ["일","월","화","수","목","금","토"];
var months$14 = ["1월","2월","3월","4월","5월","6월","7월","8월","9월","10월","11월","12월"];
...
var days$15 = ["недела","понеделник","вторник","среда","четврток","петок","сабота"];
var shortDays$15 = ["нед","пон","вто","сре","чет","пет","саб"];
var months$15 = ["јануари","февруари","март","април","мај","јуни","јули","август","септември","октомври","ноември","декември"];
...
var days$16 = ["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"];
var shortDays$16 = ["zo","ma","di","wo","do","vr","za"];
var months$16 = ["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"];
...
var days$17 = ["Niedziela","Poniedziałek","Wtorek","Środa","Czwartek","Piątek","Sobota"];
var shortDays$17 = ["Niedz.","Pon.","Wt.","Śr.","Czw.","Pt.","Sob."];
var months$17 = ["Styczeń","Luty","Marzec","Kwiecień","Maj","Czerwiec","Lipiec","Sierpień","Wrzesień","Październik","Listopad","Grudzień"];
...
var days$18 = ["Domingo","Segunda","Terça","Quarta","Quinta","Sexta","Sábado"];
var shortDays$18 = ["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"];
var months$18 = ["Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"];
...
var days$19 = ["воскресенье","понедельник","вторник","среда","четверг","пятница","суббота"];
var shortDays$19 = ["вс","пн","вт","ср","чт","пт","сб"];
var months$19 = ["января","февраля","марта","апреля","мая","июня","июля","августа","сентября","октября","ноября","декабря"];
...
var days$20 = ["Söndag","Måndag","Tisdag","Onsdag","Torsdag","Fredag","Lördag"];
var shortDays$20 = ["Sön","Mån","Tis","Ons","Tor","Fre","Lör"];
var months$20 = ["Januari","Februari","Mars","April","Maj","Juni","Juli","Augusti","September","Oktober","November","December"];
...
var date$22 = "%Y年%-m月%-d日";
var time$22 = "%H:%M:%S";
var periods$21 = ["上午","下午"];
var days$21 = ["星期日","星期一","星期二","星期三","星期四","星期五","星期六"];
var shortDays$21 = ["周日","周一","周二","周三","周四","周五","周六"];
var months$21 = ["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"];
...
var DEFAULT_SIZE = 270;
var DEFAULT_ASPECT = 1;
var DEFAULT_MARGIN = 12;  // white space
var DEFAULT_INSET = 0;   // scale space
var DEFAULT_LEGEND_SIZE = 10;
var DEFAULT_LEGEND_PADDING_X = 8;
var DEFAULT_LEGEND_PADDING_Y = 24;
var DEFAULT_LEGEND_TEXT_SCALE = 8; // hack value to do fast estimation of length of string
var DEFAULT_CORNER_RADIUS = 3;
var DEFAULT_LINE_PADDING = 3;
var DEFAULT_TICK_FORMAT_VALUE = ',.0f';
var DEFAULT_TICK_FORMAT_VALUE_SI = '.2s';
var DEFAULT_TICK_FORMAT_VALUE_SMALL = '.3f';

// Font fallback chosen to keep presentation on places like GitHub where Content Security Policy prevents inline SRC
var DEFAULT_STYLE = [ "@import url(https://fonts.googleapis.com/css?family=Source+Code+Pro:300);",
                        "text{ font-family: 'Source Code Pro', Consolas, 'Liberation Mono', Menlo, Courier, monospace; font-weight: 300; }",
                        ".legend text { font-size: 12px }"
                      ].join(' \n');

function polars(id) {
  var classed = 'chart-polars', 
      theme = 'light',
      background = null,
      width = DEFAULT_SIZE,
      height = null,
  ...
  function _impl(context) {
    ...
    var defaultValueFormat = format(DEFAULT_TICK_FORMAT_VALUE);
    var defaultValueFormatSi = format(DEFAULT_TICK_FORMAT_VALUE_SI);
    var defaultValueFormatSmall = format(DEFAULT_TICK_FORMAT_VALUE_SMALL);  

    var displayFn = displayValue;
    if (displayFn == null) {
      if (displayFormatValue != null) {
        var fn = format(displayFormatValue);
        displayFn = function (i) { return fn(i); }; 
      } else {
    ...
    selection.each(function() {
      ...
      var sid = null;
      if (id) sid = 'svg-' + id;
      var root = svg(sid).width(width).height(sh).margin(margin).scale(scale);
      var tnode = node;
      if (transition === true) {
      ...
      var elmS = node.select(root.self()).select(root.child());

      // Tip
      var tid = null;
      if (id) tid = 'tip-' + id;
      var rtip = tip(tid).html(function (d) { return d; });
      var st = style + ' ' + rtip.style();
      rtip.style(st);
      elmS.call(rtip);
      ...
      var vdata = data.map(function (d, i) { return value(d, i); });
      ...
      if (legend.length > 0) {
        ...
        var rg = g.select('g.legend');
        var lg = rg.attr('transform', 'translate(' + (w/2) + ',' + (h + DEFAULT_LEGEND_PADDING_Y) + ')').selectAll('g').data(legend);
        lg.exit().remove();
        var newlg = lg.enter().append('g');
        
        var colors$1 = _makeFillFn();
        ...
        newlg.append('text')
          ...
          .attr('x', function () { return DEFAULT_LEGEND_SIZE + DEFAULT_LEGEND_PADDING_X; });
              
        lg = newlg.merge(lg);

        lg.selectAll('text').text(function (d) { return d; });

        var lens = legend.map(function (s) { return s.length * DEFAULT_LEGEND_TEXT_SCALE + DEFAULT_LEGEND_SIZE + 2 * DEFAULT_LEGEND_PADDING_X; });
        var clens = []
        var total = lens.reduce(function (p, c) { return (clens.push(p) , p + c); }, 0);
        
        var offset = -total / 2;
        rg.selectAll('g').data(clens).attr('transform', function (d) { return 'translate(' + (offset + d) + ',0)'; });
      }            
      ...
      var pad = padAngle / 2;
      var startA = function () { return startAngle + pad; };
      var endA = function (d) { return d * 2 * Math.PI + startAngle - pad; };

      if (reverse) {
        startA = function () { return 2 * Math.PI + startAngle - pad; };
        endA = function (d) { return (1.0 - d) * 2 * Math.PI + startAngle + pad; };
      }

      var colors = _makeFillFn();
      var arcs = arc()
            .innerRadius(function (d, i) { return radius - ((thickness + padding) * (i + 1) ) + padding; })
            .outerRadius(function (d, i) { return radius - ((thickness + padding) * i ); })
            .startAngle(startA)
            .endAngle(endA)
            .cornerRadius(cornerRadius);
      
      var centerX = w / 2 - inset;      
      var polars = g.select('g.polar')
                  .attr('transform', 'translate(' + centerX + ',' + (radius + inset) + ')')
                  .selectAll('g.slice').data(vdata);  
      polars.exit().remove();
      var newSlices = polars.enter().append('g').attr('class', 'slice');
      ...
      var paths = polars.selectAll('path').data(function (d, i) { return [ [ d, i ] ]; });
      
      if (transition === true) {
        paths = paths.transition(context);
        var tween = function (prev) {
          
          paths.attrTween('d', function(d) { 
            var start = 0;
            if (d[1] < prev.length) start = prev[d[1]];
            
            var i = interpolateNumber(start, d[0]);
        ...
        paths.attr('d', function (d) { return arcs(d[0], d[1]); });
      }
      
      paths.attr('fill', function (d) { return colors(d[0], d[1]); });
      previous = vdata;
/*
...
LoadingIndicator.prototype.start = function start () {
  this._infinite = polars('infinite')
    .padAngle(0.01)
    .outerRadius(80)
    .margin(0)
    .thickness(2)
...
LoadingIndicator.prototype.stop = function stop () {
  if (this._interval) {
...
LoadingIndicator.prototype._spin = function _spin () {
  var direction = (this._outer === 0);
...
/**
 * sift-jitmail: webhook sending utility class
 *
 * Copyright (c) 2016 Redsift Limited
 */
 ...
 * Copyright (c) 2016 Redsift Limited
 */
var Login = function Login(owhurl) {
  this._webhook = new Webhook(owhurl);
  this._eventHandler = null;
};

Login.prototype.setup = function setup (eh) {
  ...
  var signin = document.getElementById('google-signin');
  signin.addEventListener('click', this._onClick.bind(this));
};

Login.prototype._onClick = function _onClick () {
    var this$1 = this;
  ...
  OAuthIO.OAuth.popup('google', { authorize: { approval_prompt: 'force' }, state: state }).done(function (result) {
    console.log('sift-jitmail: google: result: ', result);
    this$1._webhook.send('google', JSON.stringify({ code: result.code, state: state }));
  }).fail(function (err) {
    console.error('sift-jitmail: google: fail', err);
    if(this$1._eventHandler) {
      // TODO: also propagate error or show a toast
      this$1._eventHandler('fail');
    }
  });
};
 ...
 * @returns guid - a GUID
 */
Login.prototype._generateGUID = function _generateGUID () {
 ...
 * Copyright (c) 2016 Redsift Limited
 */
var TimeSelector = function TimeSelector(time, date, button, clock, clockSize) {
  this.selected = null;
  this.value = {
    minutes: 0,
    hours: 0,
...
TimeSelector.prototype.setup = function setup () {
    var this$1 = this;
  ...
  for (var i = 0; i < radios.length; i++) {
    var r = radios.item(i);
    r.addEventListener('click', this$1._onPrecision.bind(this$1));
  }
};

TimeSelector.prototype._onPrecision = function _onPrecision (ev) {
...
TimeSelector.prototype._onInput = function _onInput (ev) {
    var this$1 = this;
  ...
  Object.keys(this.value).forEach(function (k) {
    when.add(this$1.value[k], k);
    delta += this$1.value[k];
  });
  if (delta > 0) {
    // Round it to the closest 15 minutes interval to match cron
    var round = (Math.round(when.minute() / 15) * 15) % 60;
    var carry = Math.floor((Math.round(when.minute() / 15) * 15) / 60);
    when.minute(round);
...
TimeSelector.prototype.displayClock = function displayClock (when) {
  console.log('time-selector: displayClock: ', when);
  var clocktime = { minutes: 0, hours: 0, days: 0 };
  if (when) {
    clocktime.minutes = when.minutes() / this.config.minutes.max;
    clocktime.hours = when.hours() / this.config.hours.max;
    clocktime.days = when.diff(moment$1(), 'days') / this.config.days.max;
    // Display the time
 ...
 * Copyright (c) 2016 Redsift Limited
 */
var EmailThreadView = (function (SiftView) {
  ...
  if ( SiftView ) EmailThreadView.__proto__ = SiftView;
  EmailThreadView.prototype = Object.create( SiftView && SiftView.prototype );
  EmailThreadView.prototype.constructor = EmailThreadView;

  EmailThreadView.prototype.onLoad = function onLoad () {
    // Initialise time selector
    this._timeSelector.setup();
  };

  EmailThreadView.prototype.onDetail = function onDetail (detail) {
    this._data.detail = detail;
    this._showView(this._selectView());
  };

  EmailThreadView.prototype.onAuth = function onAuth (loggedIn) {
    this._data.signin = !loggedIn;
    this._showView(this._selectView(this._data));
  };

  // TODO: link to docs
  EmailThreadView.prototype.presentView = function presentView (value) {
    var sv = 'loader';
    if (value.data) {
  ...
  // TODO: link to docs
  EmailThreadView.prototype.willPresentView = function willPresentView (value) { };

  EmailThreadView.prototype._onLogin = function _onLogin (state) {
    var sv = 'loader';
    if(state === 'fail') {
      sv = 'signin';
    }
  ...
  EmailThreadView.prototype._selectView = function _selectView () {
    var sv = 'loader';
    if (this._data.detail.snoozed) {
      this._snoozedDisplay.displayClock(moment$1(this._data.detail.snoozed));
      sv = 'snoozed-display';
    }
    else {
      sv = 'snoozer';
  ...
  EmailThreadView.prototype._showView = function _showView (id) {
  ...
  EmailThreadView.prototype._setupSnoozeButton = function _setupSnoozeButton () {
    var snb = document.getElementById('snooze-button');
    snb.addEventListener('click', this._onSnooze.bind(this));
    return snb;
  };

  EmailThreadView.prototype._onSnooze = function _onSnooze () {
    ...
    var wh = new Webhook(this._data.snwhurl);
