...
var timeSunday = weekday$1(0);
var timeMonday = weekday$1(1);
...
function formatWeekNumberSunday$1(d, p) {
  return pad$1(timeSunday.count(year$1(d), d), p, 2);
}
...
function formatWeekNumberMonday$1(d, p) {
  return pad$1(timeMonday.count(year$1(d), d), p, 2);
}
...
function formatUTCWeekNumberSunday$1(d, p) {
  return pad$1(utcWeek.count(utcYear$1(d), d), p, 2);
}
...
function scaleTime() {
  return calendar(year$1, month$1, timeSunday, day$1, hour$1, minute$1, second$1, millisecond$1, timeFormat$1).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]);
}
...
function chart(id) {
  ...
  var classed = 'squares-chart',
      ...
      minDate = null,
      maxDate = null,
      D = function (d) { return new Date(d); },
...
var time$1 = "%H:%M:%S";
var periods = ["AM","PM"];
var days$2 = ["diumenge","dilluns","dimarts","dimecres","dijous","divendres","dissabte"];
var shortDays = ["dg.","dl.","dt.","dc.","dj.","dv.","ds."];
var months$2 = ["gener","febrer","març","abril","maig","juny","juliol","agost","setembre","octubre","novembre","desembre"];
...
var days$9 = ["sunnuntai","maanantai","tiistai","keskiviikko","torstai","perjantai","lauantai"];
var shortDays$7 = ["Su","Ma","Ti","Ke","To","Pe","La"];
var months$9 = ["tammikuu","helmikuu","maaliskuu","huhtikuu","toukokuu","kesäkuu","heinäkuu","elokuu","syyskuu","lokakuu","marraskuu","joulukuu"];
...
var days$12 = ["ראשון","שני","שלישי","רביעי","חמישי","שישי","שבת"];
var shortDays$10 = ["א׳","ב׳","ג׳","ד׳","ה׳","ו׳","ש׳"];
var months$12 = ["ינואר","פברואר","מרץ","אפריל","מאי","יוני","יולי","אוגוסט","ספטמבר","אוקטובר","נובמבר","דצמבר"];
...
var days$13 = ["vasárnap","hétfő","kedd","szerda","csütörtök","péntek","szombat"];
var shortDays$11 = ["V","H","K","Sze","Cs","P","Szo"];
var months$13 = ["január","február","március","április","május","június","július","augusztus","szeptember","október","november","december"];
...
var days$14 = ["Domenica","Lunedì","Martedì","Mercoledì","Giovedì","Venerdì","Sabato"];
var shortDays$12 = ["Dom","Lun","Mar","Mer","Gio","Ven","Sab"];
var months$14 = ["Gennaio","Febbraio","Marzo","Aprile","Maggio","Giugno","Luglio","Agosto","Settembre","Ottobre","Novembre","Dicembre"];
...
var days$15 = ["日曜日","月曜日","火曜日","水曜日","木曜日","金曜日","土曜日"];
var shortDays$13 = ["日","月","火","水","木","金","土"];
var months$15 = ["睦月","如月","弥生","卯月","皐月","水無月","文月","葉月","長月","神無月","霜月","師走"];
...
var days$16 = ["일요일","월요일","화요일","수요일","목요일","금요일","토요일"];
var shortDays$14 = ["일","월","화","수","목","금","토"];
var months$16 = ["1월","2월","3월","4월","5월","6월","7월","8월","9월","10월","11월","12월"];
...
var days$17 = ["недела","понеделник","вторник","среда","четврток","петок","сабота"];
var shortDays$15 = ["нед","пон","вто","сре","чет","пет","саб"];
var months$17 = ["јануари","февруари","март","април","мај","јуни","јули","август","септември","октомври","ноември","декември"];
...
var days$18 = ["zondag","maandag","dinsdag","woensdag","donderdag","vrijdag","zaterdag"];
var shortDays$16 = ["zo","ma","di","wo","do","vr","za"];
var months$18 = ["januari","februari","maart","april","mei","juni","juli","augustus","september","oktober","november","december"];
...
var days$19 = ["Niedziela","Poniedziałek","Wtorek","Środa","Czwartek","Piątek","Sobota"];
var shortDays$17 = ["Niedz.","Pon.","Wt.","Śr.","Czw.","Pt.","Sob."];
var months$19 = ["Styczeń","Luty","Marzec","Kwiecień","Maj","Czerwiec","Lipiec","Sierpień","Wrzesień","Październik","Listopad","Grudzień"];
...
var days$20 = ["Domingo","Segunda","Terça","Quarta","Quinta","Sexta","Sábado"];
var shortDays$18 = ["Dom","Seg","Ter","Qua","Qui","Sex","Sáb"];
var months$20 = ["Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"];
...
var days$21 = ["воскресенье","понедельник","вторник","среда","четверг","пятница","суббота"];
var shortDays$19 = ["вс","пн","вт","ср","чт","пт","сб"];
var months$21 = ["января","февраля","марта","апреля","мая","июня","июля","августа","сентября","октября","ноября","декабря"];
...
var days$22 = ["Söndag","Måndag","Tisdag","Onsdag","Torsdag","Fredag","Lördag"];
var shortDays$20 = ["Sön","Mån","Tis","Ons","Tor","Fre","Lör"];
var months$22 = ["Januari","Februari","Mars","April","Maj","Juni","Juli","Augusti","September","Oktober","November","December"];
...
var days$23 = ["星期日","星期一","星期二","星期三","星期四","星期五","星期六"];
var shortDays$21 = ["周日","周一","周二","周三","周四","周五","周六"];
var months$23 = ["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"];
...
var DEFAULT_ASPECT$1 = 1;
var DEFAULT_MARGIN = 12;  // white space
var DEFAULT_INSET$1 = 0;   // scale space
...
function polars(id) {
  ...
  function _makeFillFn() {
    ...
    if (fill == null) {
      var c = presentation10$2.standard;
  ...
  function _impl(context) {
    ...
    defaultLocale$1(units(language).d3);
    ...
    selection.each(function() {
      var node = select(this);  
      var sh = height || Math.round(width * DEFAULT_ASPECT$1);
      ...
      var tid = null;
      if (id) tid = 'tip-' + id;
      var rtip = tip$1(tid).html(function (d) { return d; });
...
var SummaryView = (function (SiftView) {
  ...
  SummaryView.prototype.onLoad = function onLoad () {
    var this$1 = this;

    this._setupHelp();
    this.controller.subscribe('auth', function (loggedIn) {
      if (loggedIn) {
        this$1._showView('calendar');
        this$1._drawCalendar('snoozedcal', this$1._data.snoozedcal || []);
        this$1._drawCalendar('sendlatercal', this$1._data.sendlatercal || []);
      }
      else {
        this$1._showView('signin');
      }
    });
    var gotos = document.getElementsByClassName('goto__button');
    for (var i = 0; i < gotos.length; i++) {
      gotos[i].addEventListener('click', function (event) {
        event.preventDefault();
        this$1.publish('goto', event.target.id);
      });
    }
  };

  SummaryView.prototype.onResize = function onResize () {
    this._drawCalendar('snoozedcal', this._data.snoozedcal);
    this._drawCalendar('sendlatercal', this._data.sendlatercal);
  };

  SummaryView.prototype.onCalendarUpdated = function onCalendarUpdated (ev) {
    if (ev.snoozedcal) {
    ...
    var total = this._countQueued(this._data.snoozedcal);
  ...
  SummaryView.prototype.presentView = function presentView (value) {
    ...
    if (value.client !== 'crx') {
      var viewButtons = document.getElementsByClassName('goto__button');
  ...
  SummaryView.prototype._countQueued = function _countQueued (queue) {
    var count = 0;
  ...
  SummaryView.prototype._drawCalendar = function _drawCalendar (name, data) {
    var contentArea = document.querySelector('.calendar__row--centered');
    var calWeeks = 24;
    var scale = contentArea.clientWidth / 600;
...
*/
    ...
    if (!_tip) {
      _tip = tip('tip-cal')
        .html(function (d) {
          if (d.z > 0) {
            return moment$1(d.x).calendar(null, {
              sameDay: '[Today]',
              nextDay: '[Tomorrow]',
              nextWeek: 'dddd',
              lastDay: '[Yesterday]',
    ...
    if(!this._calendar[name]) {
      this._calendar[name] = chart('calendar-' + name)
        .type('calendar.days')
        .minDate(moment$1().valueOf())
        .nice(false)
        .margin(0)
        .color('orange');
    }
    select('#' + name).datum(data).call(this._calendar[name].scale(scale).maxDate(moment$1().add(calWeeks, 'weeks').valueOf()));
  ...
  SummaryView.prototype._onLogin = function _onLogin (state) {
    var sv = 'loader';
    if (state === 'fail') {
      sv = 'signin';
    }
  ...
  SummaryView.prototype._showView = function _showView (id) {
  ...
  SummaryView.prototype._setupHelp = function _setupHelp () {
