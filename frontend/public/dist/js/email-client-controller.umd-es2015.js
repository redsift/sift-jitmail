 ...
 */
var JITMailEmailClientController = (function (EmailClientController) {
  function JITMailEmailClientController() {
    EmailClientController.call(this);
  }

  if ( EmailClientController ) JITMailEmailClientController.__proto__ = EmailClientController;
  JITMailEmailClientController.prototype = Object.create( EmailClientController && EmailClientController.prototype );
  JITMailEmailClientController.prototype.constructor = JITMailEmailClientController;

  JITMailEmailClientController.prototype.loadThreadListView = function loadThreadListView (listInfo) {
    if (listInfo) {
      var st;
      if (listInfo.snoozed) {
        st = 'Snoozed: ' + moment$1(listInfo.snoozed).calendar();
      }
      else if (listInfo.sendlater) {
        st = 'Send later: ' + moment$1(listInfo.sendlater).calendar();
      }
      if (st) {
        return {
  ...
  return JITMailEmailClientController;
